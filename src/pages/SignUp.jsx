                ...
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <div className="mt-6  w-full">
                        ...
                        <div className="relative flex items-center justify-center">
                            <input aria-label="enter Password" role="input" type={`${showPass ? "text" : "password"}`} className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
