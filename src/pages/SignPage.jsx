                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="mt-6  w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                <input {...register("password", { required: true})} aria-label="enter Password" role="input" type={`${showPass ? "text" : "password"}`} className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
